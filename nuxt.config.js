      ...
      plugins: {
        "postcss-px-to-viewport": {
          ...
          propList: [
            ...
            'padding','padding-left','padding-top','padding-right','padding-bottom','border','border-radius', 'box-shadow',
            'margin','margin-left','margin-top','margin-right','margin-bottom','line-height','text-shadow',
          ],
        ...
        'postcss-pxtorem': {
          ...
          selectorBlackList: ['.ignore', '.ignore-vw', 'mobile','body','html'],
          replace: true,
          mediaQuery: false,
          minPixelValue: 0,
