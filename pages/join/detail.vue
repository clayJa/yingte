  ...
  <div class="index-wrapper">
    ...
    <div class="wrapper">
      ...
      <div class="pager-wrapper">
        <div :class="`prev step ${!articleData.previous ? 'disabled' : ''}`" @click="toPath(articleData.previous)"><i
          class="iconfont icon">&#xe608;</i>上一页
        </div>
        <div :class="`next step ${!articleData.next ? 'disabled' : ''}`" @click="toPath(articleData.next)">下一页<i
          class="iconfont icon">&#xe60a;</i></div>
      </div>
    </div>
    <ContactUs/>
    <Footer/>
  ...
  export default {
    ...
    methods: {
      ...
      async fetchData() {
        ...
        this.articleData.updated_at.replace('-', '/');
        let update_time = new Date(this.articleData.updated_at);
        let month = update_time.getMonth() < 10 ? '0' + update_time.getMonth() : update_time.getMonth();
        let day =  update_time.getDay() < 10 ? '0' + update_time.getDay() : update_time.getDay();
        this.articleData.updated_at = update_time.getFullYear() + '-' + month + '-' + day
      },
    },
    components: {
      Breadcrumb,
